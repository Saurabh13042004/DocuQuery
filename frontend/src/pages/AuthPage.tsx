...
function SignInForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        ...
        <div className="grid gap-2">
          ...
          <Input id="email" type="email" placeholder="m@example.com" required autoComplete="email" {...register('email')} />
          {errors.email && <p className="mt-1 text-sm text-red-600">{errors.email.message}</p>}
        </div>
        <div className="grid gap-2">
          <PasswordInput id="password" label="Password" required autoComplete="current-password" placeholder="Password" {...register('password')} />
...
const signupSchema = z.object({
  ...
  email: z.string().email('Invalid email address'),
  password: z.string().min(8, 'Password must be at least 8 characters'),
  // Removed confirmPassword because the reference UI only has one password field
});
    ...
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        ...
        <div className="grid gap-1">
          ...
          <Input id="name" type="text" placeholder="John Doe" required autoComplete="name" {...register('name')} />
        ...
        <div className="grid gap-2">
          <PasswordInput id="password" label="Password" required autoComplete="new-password" placeholder="Password" {...register('password')} />
          {errors.password && <p className="mt-1 text-sm text-red-600">{errors.password.message}</p>}
        </div>
        <Button type="submit" variant="outline" className="mt-2" disabled={isSubmitting}>
...
function AuthFormContainer({ isSignIn, onToggle }: { isSignIn: boolean; onToggle: () => void; }) {
    ...
    return (
        <div className="mx-auto grid w-[350px] gap-2">
            <Link to="/" className="absolute top-8 left-8 flex items-center text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
            ...
            <div className="text-center text-sm">
                ...
                <Button variant="link" className="pl-1 text-foreground" onClick={() => {
                  onToggle();
...
export default function AuthPage({ defaultIsSignIn = true, signInContent = {}, signUpContent = {} }: AuthUIProps) {
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      `}</style>
      <div className="relative flex h-screen items-center justify-center p-6 md:h-auto md:p-0 md:py-12">
