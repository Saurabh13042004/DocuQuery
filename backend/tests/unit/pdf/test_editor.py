"""Tests for the PDF text-replacement engine (app/pdf/editor.py).
...
from app.pdf import editor as pe

DEJAVU = Path(__file__).resolve().parents[3] / "fonts" / "DejaVuSerifCondensed.ttf"
